"""
Django settings for forestcollege project.

Generated by 'djangocms' command using django CMS 4.1.4 and Django 5.1.3.
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, "forestcollege", "templates"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'forestcollege.wsgi.application'
...
CMS_PLACEHOLDER_CONF = {
    'default': {
        'plugins': ['TextPlugin', 'BlockquotePlugin'],
        'name': 'Default',
        'permissions': True,
    },
}
